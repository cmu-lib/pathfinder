...
render_pathway_plot <- function(graph, bundles, distances, pathway) {
  ...
  edge_status <- ifelse(pathway_augmented$times_edge_crossed > 0, ifelse(is.na(pathway_augmented$bundle_id), "path", "bundled"), "none")
  ...
  plot(plot_graph, 
       ...
       curved = FALSE, 
       edge.arrow.mode = 0,
       edge.color = c(path = "blue", bundled = "red", none = "gray80")[edge_status],
       edge.width = c(path = 2, bundled = 3, none = 0.2)[edge_status])
}
